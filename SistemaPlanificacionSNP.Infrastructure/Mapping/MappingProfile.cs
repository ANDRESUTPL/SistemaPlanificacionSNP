...
namespace SistemaPlanificacionSNP.Infrastructure.Mapping
{
	...
	public class MappingProfile : Profile
	{
		public MappingProfile()
		{
			...
			// 👇 NUEVAS LÍNEAS AÑADIDAS PARA MAPEAR RUTA Y DEMÁS CAMPOS DE PANTALLA 👇
			.ForMember(dest => dest.Ruta, opt => opt.MapFrom(src => src.Pantalla != null ? src.Pantalla.Ruta : string.Empty))
			.ForMember(dest => dest.PantallaPadrId, opt => opt.MapFrom(src => src.Pantalla != null ? src.Pantalla.PantallaPadrId : null));
			// ==================== PANTALLA Y MENÚ ====================
