...
using SistemaPlanificacionSNP.PlanificacionInstitucional.FunctionalTests.Infrastructure;

namespace SistemaPlanificacionSNP.PlanificacionInstitucional.FunctionalTests.Integration;

public sealed class PlanEstrategicoInstitucionalTests : PlanificacionInstitucionalWebApplicationFactory
{
    [Fact]
